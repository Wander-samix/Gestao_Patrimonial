...
urlpatterns = [
    ...
    path('dashboard/exportar-estoque-por-area/',exportar_estoque_por_area_excel,
    ...
    #path('areas/<int:area_id>/produtos/', produtos_por_area, name='produtos_por_area'),
    ...
    path('sessoes/', lista_sessoes, name='exportar_sessoes_excel'),
